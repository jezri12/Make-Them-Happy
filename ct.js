...
ct.inputs.addAction('YMove', [{"code":"keyboard.KeyW","multiplier":-1},{"code":"keyboard.KeyS","multiplier":1},{"code":"keyboard.ArrowUp","multiplier":-1},{"code":"keyboard.ArrowDown"}]);
ct.inputs.addAction('XMove', [{"code":"keyboard.KeyD"},{"code":"keyboard.KeyA","multiplier":-1},{"code":"keyboard.ArrowRight"},{"code":"keyboard.ArrowLeft","multiplier":-1}]);
ct.inputs.addAction('Continue', [{"code":"keyboard.Space"}]);
...
ct.rooms.templates['Main-Game-Room'] = {
    ...
    height: 600,
    objects: [],
    bgs: [{"depth":0,"texture":"Blue","extends":{}}],
    tiles: [{"depth":-10,"tiles":[]}],
    onStep() {
        if(!this.gameover){

    if(this.pSpawnTimer > 0){
        this.pSpawnTimer --
    }else{
        this.pSpawnTimer -= 2
        this.pSpawnTimer = this.pSSpawnTimer
        ct.types.copy("Happy Person",ct.random.range(64,800-128),ct.random.range(64,600-128))
    }
...
ct.types.copy("Player",384,256)

this.scoreLabelStyle = ct.styles.get("ScoreStyle")

this.scoreLabel = new PIXI.Text('Score: ' + this.score,this.scoreLabelStyle);
...
ct.rooms.templates['Gameover'] = {
    name: 'Gameover',
    width: 800,
    height: 600,
    objects: [{"x":384,"y":256,"type":"Sad Player"},{"x":384,"y":256,"type":"Sad Player"},{"x":384,"y":256,"type":"Sad Player"}],
    bgs: [{"depth":-3,"texture":"Blue","extends":{}}],
    tiles: [{"depth":-10,"tiles":[]}],
    onStep() {
        if(ct.actions.Continue.value){
...
(function (ct) {
    ...
    ct.res = {
        ...
        soundsError: 0,
        sounds: {},
        registry: [{"Sad":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Happy":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Angry":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Meh":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Grass":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Blue":{"atlas":"./img/t0.png","frames":0,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}}}][0],
...
if(ct.place.meet(this,"Happy Person")){
    ct.room.score += 500
}else if(ct.place.meet(this,"Meh Person")){
    ct.room.score += 250
}else if(ct.place.meet(this,"Sad Person")){
    ct.room.score += 50
}
...
ct.types.templates["Happy Person"] = {
    depth:0,
    texture: "Happy",
    onStep: function () {
if(this.cTimer > 0){
    ...
    ct.types.copy("Meh Person",this.x,this.y)
    this.kill = true
}

if(ct.place.meet(this,"Player")){
    this.kill = true
    ct.sound.spawn("Save",{loop:false})
}
...
this.cTimer = 60
    ...
    extends: {}};
ct.types.list['Happy Person'] = [];
ct.types.templates["Meh Person"] = {
    depth:0,
    texture: "Meh",
    onStep: function () {
if(this.cTimer > 0){
    ...
    ct.types.copy("Sad Person",this.x,this.y)
    this.kill = true
}
...
this.cTimer = 60
    ...
    extends: {}};
ct.types.list['Meh Person'] = [];
ct.types.templates["Sad Person"] = {
    depth:0,
    texture: "Sad",
    onStep: function () {
if(this.cTimer > 0){
    ...
    ct.types.copy("Angry Person",this.x,this.y)
    this.kill = true
}
...
this.cTimer = 60
    ...
    extends: {}};
ct.types.list['Sad Person'] = [];
ct.types.templates["Angry Person"] = {
    depth:0,
    texture: "Angry",
    onStep: function () {
if(this.gTimer > 0){
...
ct.sound.spawn("Lost",{loop:false})
    },
    onCreate: function () {
this.gTimer = 120
    },
    extends: {}};
ct.types.list['Angry Person'] = [];
ct.types.templates["Sad Player"] = {
    depth:0,
    texture: "Sad",
    onStep: function () {
this.move();
...
ct.sound.init('Save', {
    wav: './snd/c98c6ba9-310c-47c4-977c-898de89811a7.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('Lost', {
    wav: './snd/7bb72a2a-87c4-42fc-94a3-5ce854be2082.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('Music', {
    wav: false,
    mp3: './snd/b8ae2228-fcae-460c-9ffc-fa9ad86ef728.mp3',
    ogg: false
}, {
    poolSize: 5,
    music: true
...
ct.sound.init('LOST', {
    wav: false,
    mp3: './snd/e33c2e34-5f5a-4e4e-a921-e8970e0ed88b.mp3',
    ogg: false
}, {
    poolSize: 5,
    music: true
